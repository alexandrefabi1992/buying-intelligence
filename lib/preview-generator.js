...
function assessCompleteness({ products, parserWarnings, declared_units_total, summed_units_total, thresholds, extraction_source, rawText }) {
  ...
  // 4. Size-mismatch — LLM extractions ONLY. Recipe path anchors qtys to
